   ...
   public class SaleData
    {
        public void SaveSale(SaleModel saleInfo, string cashierId)
        {
            ...
            sql.SaveData("dbo.spSale_Insert", sale, "KPPData");

            // Get the ID from the sale mode
            sale.Id = sql.LoadData<int, dynamic>("spSale_Lookup", new { sale.CashierId, sale.SaleDate }, "KPPData").FirstOrDefault();
            ...
            foreach (var item in details)
            {
                ...
                sql.SaveData("dbo.spSaleDetail_Insert", item, "KPPData");
            }
        }
    }
}
