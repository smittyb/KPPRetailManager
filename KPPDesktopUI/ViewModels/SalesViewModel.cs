...
using KPPDesktopUI.Library.Helpers;
    ...
    public class SalesViewModel : Screen
    {
        ...
        protected override async void OnViewLoaded(object view)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    _status.UpdateMessage("Unauthorized Access", "You do not have permission to interact withthe Sales Form");
        ...
        private decimal CalculateTax()
        {
            ...
            //// Refactored below to above to make what's happening slightly clearer and eliminate parens
            //foreach (var item in Cart)
            //{
        ...
        public async Task CheckOut()
        {
            ...
            // if unauthorized to make sale -- wrap first await statement in try/catch
